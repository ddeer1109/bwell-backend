...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public static final int COOKIE_EXP_SEC = 1000;
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest,
        ...
        CookieUtils.addCookie(response, OAUTH2_AUTH_REQUEST_COOKIE_NAME, CookieUtils.serialize(authorizationRequest), COOKIE_EXP_SEC);
        ...
        if (redirectUriAfterLogin != null && !redirectUriAfterLogin.equals("")){
            CookieUtils.addCookie(response, REDIRECT_URI_COOKIE_NAME, redirectUriAfterLogin, COOKIE_EXP_SEC);
        }
